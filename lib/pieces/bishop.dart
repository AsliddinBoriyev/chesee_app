import 'package:chesee_app/pieces/chess_piece.dart';
import 'package:flutter/foundation.dart';

class Bishop extends ChessPiece {
  @override
  String get name => "bishop";
  Bishop(PlayerColor pieceColor,
      Location location,) :super(pieceColor, location);
  ...
  List<Location> _generateMovesOnDiagonal(bool isUp,
      bool isRight,
      List<ChessPiece> piece,) {
    ...
    return List<Location?>.generate(8, (i) {
      ...
      piece.any((piece) => piece.location == destination);
  ...
  List<Location> _generateCapturesOnDiagonal(bool isUp,
      bool isRight,
      List<ChessPiece> piece,) {
